...
public class TrainingRecordServiceImplTest {
    ...
    void setUp() {
        ...
        trainingRecord.setTitle("Java高级开发培训");
        trainingRecord.setType("技术培训");
        trainingRecord.setStartDate(LocalDate.of(2023, 10, 1));
        trainingRecord.setEndDate(LocalDate.of(2023, 10, 5));
        trainingRecord.setDuration(20.0); // 20小时
        trainingRecord.setProvider("专业培训机构");
        trainingRecord.setLocation("线上");
        trainingRecord.setScore(90);
        trainingRecord.setResult("优秀");
        trainingRecord.setDescription("高级Java编程技术培训");
        trainingRecord.setEmployeeId(1L);
        trainingRecord.setEmployee(employee);
        
        trainingRecordDTO = new TrainingRecordDTO();
        trainingRecordDTO.setId(1L);
        trainingRecordDTO.setTitle("Java高级开发培训");
        trainingRecordDTO.setType("技术培训");
        trainingRecordDTO.setStartDate(LocalDate.of(2023, 10, 1));
        trainingRecordDTO.setEndDate(LocalDate.of(2023, 10, 5));
        trainingRecordDTO.setDuration(20.0);
        trainingRecordDTO.setProvider("专业培训机构");
        trainingRecordDTO.setLocation("线上");
        trainingRecordDTO.setScore(90);
        trainingRecordDTO.setResult("优秀");
        trainingRecordDTO.setDescription("高级Java编程技术培训");
        trainingRecordDTO.setEmployeeId(1L);
        trainingRecordDTO.setEmployeeName("张三");
        trainingRecordDTO.setDepartmentId(1L);
        trainingRecordDTO.setDepartmentName("研发部");
    }
    ...
    void testUpdateTrainingRecord_Success() {
        ...
        // 执行
        TrainingRecordDTO result = trainingRecordService.updateTrainingRecord(1L, trainingRecordDTO);
    ...
    void testGetTrainingRecordsByEmployeeId_Success() {
        // 准备
        List<TrainingRecord> trainingRecords = Collections.singletonList(trainingRecord);
        when(trainingRecordRepository.findByEmployeeId(1L)).thenReturn(trainingRecords);
        
        // 执行
        List<TrainingRecordDTO> result = trainingRecordService.getTrainingRecordsByEmployeeId(1L);
    ...
    void testGetTrainingRecordsByType_Success() {
        ...
        // 执行
        List<TrainingRecordDTO> result = trainingRecordService.getTrainingRecordsByType("技术培训");
    ...
    void testGetTrainingRecordsByDateRange_Success() {
        ...
        List<TrainingRecord> trainingRecords = Collections.singletonList(trainingRecord);
        when(trainingRecordRepository.findByStartDateBetween(startDate, endDate)).thenReturn(trainingRecords);
        
        // 执行
        List<TrainingRecordDTO> result = trainingRecordService.getTrainingRecordsByDateRange(startDate, endDate);
    ...
    void testGetTrainingRecordsByResult_Success() {
        ...
        // 执行
        List<TrainingRecordDTO> result = trainingRecordService.getTrainingRecordsByResult("优秀");
    ...
    void testGetTrainingRecordsByProvider_Success() {
        // 准备
        List<TrainingRecord> trainingRecords = Collections.singletonList(trainingRecord);
        when(trainingRecordRepository.findByProvider("专业培训机构")).thenReturn(trainingRecords);
        
        // 执行
        List<TrainingRecordDTO> result = trainingRecordService.getTrainingRecordsByProvider("专业培训机构");
    ...
    void testGetTrainingRecordsByDepartmentId_Success() {
        ...
        when(trainingRecordRepository.findByEmployeeIdIn(Collections.singletonList(1L))).thenReturn(trainingRecords);
        
        // 执行
        List<TrainingRecordDTO> result = trainingRecordService.getTrainingRecordsByDepartmentId(1L);
    ...
    void testGetUpcomingTrainings_Success() {
        ...
        List<TrainingRecord> trainingRecords = Collections.singletonList(trainingRecord);
        when(trainingRecordRepository.findByStartDateBetween(any(LocalDate.class), eq(futureDate))).thenReturn(trainingRecords);
        
        // 执行
        List<TrainingRecordDTO> result = trainingRecordService.getUpcomingTrainings(30);
    ...
    void testGetEmployeeAnnualTrainingHours_Success() {
        // 准备
        when(trainingRecordRepository.findByEmployeeIdAndStartDateBetween(1L, any(LocalDate.class), any(LocalDate.class)))
                .thenReturn(Collections.singletonList(trainingRecord));
        
        // 执行
        Double hours = trainingRecordService.getEmployeeAnnualTrainingHours(1L, 2023);
    ...
    void testGetAllTrainingRecords_Success() {
        ...
        // 执行
        List<TrainingRecordDTO> result = trainingRecordService.getAllTrainingRecords();
