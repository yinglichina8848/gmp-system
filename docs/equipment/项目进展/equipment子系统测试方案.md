...
## 3. 测试策略
### 3.1 单元测试
- **测试对象**：设备档案管理、设备维护管理、设备校准管理等模块的核心类和方法
